                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                             ...
                             <div class="float-right">
                                <a href="{{ route('empleado.pdf') }}" class="btn btn-dark btn-sm float-right"  data-placement="left">
                                    {{ __('Visualizar PDF') }}
                                </a>
                                &nbsp;
                                <a href="{{ route('empleado.downloadPdf') }}" class="btn btn-danger btn-sm float-right"  data-placement="left">
                                    {{ __('Imprimir PDF') }}
                                </a>
                                &nbsp;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('empleados.destroy',$empleado->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('empleados.show',$empleado->id) }}"><i class="fa fa-fw fa-eye"></i> {{ __('Ver') }}</a>
